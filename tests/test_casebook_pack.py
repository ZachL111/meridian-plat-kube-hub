"""Regression checks for the meridian-plat-kube-hub casebook."""
...
from casebook.harness import assert_expected, meridian_plat_kube_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_plat_kube_hub_summary(), assert_expected())
