...
meridian-plat-kube-hub is a Java project for platform engineering. It focuses on this technical goal: Package a Java local lab for kube analysis with framed sample traffic, bounds and ordering tests, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 170, risk penalty 6, latency penalty 2, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
