...
`meridian-plat-kube-hub` is centered on platform engineering work in Java. The technical target is: Package a Java local lab for kube analysis with framed sample traffic, bounds and ordering tests, and documented operating limits.
...
The score is deterministic. The current threshold is 170. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 2.
